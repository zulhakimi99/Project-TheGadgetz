					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav">
								<ul>
									<li class="active">
										<a href="<?php echo e(url('/login/cust')); ?>">Home</a>
									</li>
									<li class="hassubs">
										<a href="#">Categories</a>
										<ul>
											<li><a href="<?php echo e(url('/login/cust')); ?>">I Phone</a></li>
											<li><a href="<?php echo e(url('/login/cust')); ?>">Computers</a></li>
										</ul>
									</li>
									<li><a href="<?php echo e(url('/login/cust')); ?>">Feedback</a></li>
									<li><a href="<?php echo e(url('/login/cust')); ?>">My Orders</a></li>
									<li class="hassubs">
										<a href="#">Login</a>
										<ul>
										<li>
											<a class="nav-link" href="<?php echo e(url('/login/cust')); ?>"><?php echo e(__('Login')); ?></a>
										</li>
										<li>
											<a class="nav-link" href="<?php echo e(url('/register/cust')); ?>"><?php echo e(__('Register')); ?></a>
										</li>
										</ul>
									</li>
				...
				<ul class="page_menu_nav menu_mm">
					...
					<li class="page_menu_item has-children menu_mm">
						...
						<ul class="page_menu_selection menu_mm">
							<li class="page_menu_item menu_mm"><a href="<?php echo e(url('/iphonecust')); ?>">I Phone<i class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item menu_mm"><a href="<?php echo e(url('/computercust')); ?>">Computers<i class="fa fa-angle-down"></i></a></li>
						</ul>
					</li>
					<li class="page_menu_item menu_mm"><a href="<?php echo e(url('/custfeedback')); ?>">Feedback<i class="fa fa-angle-down"></i></a></li>
					<li class="page_menu_item menu_mm"><a href="<?php echo e(url('/buy')); ?>">My Orders<i class="fa fa-angle-down"></i></a></li>
				</ul>
			</div>
		</div>
							...
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										...
										<div class="button button_light home_button"><a href="<?php echo e(url('/login/cust')); ?>">Shop Now</a></div>
									</div>
								</div>
							</div>
						</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="<?php echo e(url('/login')); ?>" >Colorlib</a>
