...
<div class="super_container">
    ...
    <!--<form action="<?php echo e(route('buy.store')); ?>" method="post">
      <?php echo csrf_field(); ?>
      <div class="row">
        <div class="col-md-12">
          <strong>Nama  :</strong>
        ...
        <div class="col-md-12">
          ...
          <input type="text" name="product" value="<?php echo e($product->about); ?>"  class="form-control" readonly>
        </div>

        <div class="col-md-12">
          <strong>Price :</strong>
          <input type="text" name="price" value="<?php echo e($product->price); ?>" class="form-control" readonly>
        </div>
        ...
        <div class="col-md-12">
          <a href="<?php echo e(route('buy.index')); ?>" class="btn btn-sm btn-success">Back</a>
              ...
              <input type="hidden" value="<?php echo e($user_id); ?>" name='user_id'>
							<ul class="order_list">
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div class="order_list_title"><input type="text" name="product" value="<?php echo e($product->about); ?>" readonly></div>
									<div class="order_list_value ml-auto"><input type="text" name="price" value="<?php echo e($product->price); ?>" readonly></div>
								</li>
              </ul><br>
              <center>
              <div class="col-md-12">
              <a href="<?php echo e(url('cust')); ?>" class="btn btn-sm btn-success">Back</a>
              <button type="submit" class="btn btn-sm btn-primary">Submit</button>
              </div>
</center>
						</div>
