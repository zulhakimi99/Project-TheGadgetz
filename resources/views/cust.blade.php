							...
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										...
										<div class="button button_light home_button"><a href="{{url('/iphonecust')}}">Shop Now</a></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										...
										<div class="button button_light home_button"><a href="{{url('/computercust')}}">Shop Now</a></div>
									</div>
								</div>
							</div>
						</div>
