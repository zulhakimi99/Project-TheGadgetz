					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								...
								<div class="home_text"><p>We have the best set of Computer accessories in the whole world.</p></div>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="products">
        ...
        <br><br><br>
          ...
          @foreach ($computers as $computer)
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{asset('images/'.$computer->image)}}" alt=""></div>
							<div class="product_extra product_new"><a href="categories.html">New</a></div>
							<div class="product_content">
								<div class="product_title">{{$computer->about}}</div>
                <div class="product_price">{{$computer->price}}</div>
                <div class="product_title"><a href="{{ url('buy/buat/'.$computer->id) }}">Buy Now</a></div>
							</div>
            </div>
          @endforeach
